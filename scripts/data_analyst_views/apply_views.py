"""Apply one or more .sql files to the serving PostgreSQL project (Milestone 3.2).

Usage:
    python apply_views.py schema.sql
    python apply_views.py views_revenue.sql views_fnb.sql
