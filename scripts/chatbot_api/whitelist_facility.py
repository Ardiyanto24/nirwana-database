...
WHITELIST = {
    ...
    "housekeeping-staff-daily": {"source": "chatbot_views.v_housekeeping_staff_daily", "filters": _PROPERTY_PERIOD_FILTERS},
    ...
    "maintenance-technician-daily": {"source": "chatbot_views.v_maintenance_technician_daily", "filters": _PROPERTY_PERIOD_FILTERS},
    "rooms": {
